...
def setup_var_protocol():
    ...
    return [1, 2],['ultrasonic_msg', 'yaw_msg'],['std_msgs/Int16.msg', 'std_msgs/Float32.msg'],[['int16'], ['float32']],[['data'], ['data']],[[0], [0.0]],[[1], [1]],[[116], [111]],[[2], [4]]
...
class Publisher_node(Node):
    ...
    def __init__(self):
        super().__init__('xicro_publisher_node_ieee')
...
class Srv_client_node(Node):
    def __init__(self,Obj_uart,OnIdsrv,Ongrab,sequence):
        super().__init__('xicro_service_client_node_ieee_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
...
class Action_client_node(Node):
    def __init__(self,Obj_uart,OnIdaction,Ongrab,sequence):
        super().__init__('xicro_action_client_node_ieee_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
